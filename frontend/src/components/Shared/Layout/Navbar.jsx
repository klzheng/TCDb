...
export default function Navbar() {
    ...
    return (
        <div className="flex justify-center">
            <nav className="w-full max-w-4xl mx-4  text-secondary drop-shadow-xl py-4 overflow-hidden flex justify-between items-center border-b-2 border-gray-600">
                {/* Logo */}
                <Link to="/">
            ...
            {activeMenu && 
            <div className="absolute flex flex-col text-gray-200 right-0 top-12 bg-slate-500 rounded py-2 px-3 sm:hidden z-50 ">
                <Link
                    to="/watchlist"
