...
export default function RatingModal(props) {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full bg-zinc-900 bg-opacity-98 flex justify-center items-center z-20">
            <div className={"bg-slate-600 w-192 flex rounded space-x-2 p-2 justify-between " + (enlarge ? " h-120 " : "  ")}>
                ...
                <section className="w-3/4 flex flex-col justify-center relative my-8">
                    ...
                    <div className="flex justify-end">
                        <button
                            className="bg-green-600 text-white py-0.5 px-4 rounded-sm text-base font-semibold hover:bg-green-700 transition focus:ring-1 focus:ring-white outline-none "
                        >
                            SAVE
                        </button>
                    </div>
